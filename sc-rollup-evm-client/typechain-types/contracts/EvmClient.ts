...
export interface EvmClientInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ATTESTOR_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export namespace MessageQueuedEvent {
  export type InputTuple = [idx: BigNumberish, data: BytesLike];
  export type OutputTuple = [idx: bigint, data: string];
  export interface OutputObject {
    idx: bigint;
    data: string;
  }
...
export interface EvmClient extends BaseContract {
  connect(runner?: ContractRunner | null): EvmClient;
  ...
  pushMessage: TypedContractMethod<[data: BytesLike], [void], "nonpayable">;

  queueGetPrefix: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "pushMessage"
  ): TypedContractMethod<[data: BytesLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "queueGetPrefix"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getEvent(
    ...
    MessageQueuedEvent.InputTuple,
    MessageQueuedEvent.OutputTuple,
    MessageQueuedEvent.OutputObject
  >;
  getEvent(
    key: "MetaTxDecoded"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "MessageQueued(uint256,bytes)": TypedContractEvent<
      MessageQueuedEvent.InputTuple,
      MessageQueuedEvent.OutputTuple,
      MessageQueuedEvent.OutputObject
    >;
    MessageQueued: TypedContractEvent<
      MessageQueuedEvent.InputTuple,
      MessageQueuedEvent.OutputTuple,
      MessageQueuedEvent.OutputObject
    >;
