...
serve({
  ...
  routes: {
    "/": new Response("" +
        ...
        "<li><a href='/worker/tdx-quote-raw'>/worker/tdx-quote-raw</a>: The `reportdata` is the worker public key and generates the quote for attestation report. The difference from `/tdx_quote` is that you can see the raw text `Price Feed Oracle` in <a href='https://proof.t16z.com/' target='_blank'>Attestation Explorer</a>.</li>" +
